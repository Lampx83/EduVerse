...
export const ACHIEVEMENTS = [
  ...
  { id: 'streak-5',     icon: '🔥', title: 'Cháy 5 ngày',
    ...
    trigger: { streak: 5 } },
  { id: 'streak-14',    icon: '⚡', title: 'Hai tuần kinh tế',
    desc: 'Streak 14 ngày liên tiếp',
    trigger: { streak: 14 } },
  { id: 'streak-30',    icon: '🌙', title: 'Tháng vàng Kinh tế',
  ...
  { id: 'star-60',      icon: '💫', title: 'Sao Kinh tế',
    desc: '60 sao tích luỹ',
    trigger: { totalStars: 60 } },
  { id: 'star-90',      icon: '🏅', title: 'Huyền thoại Kinh tế',
