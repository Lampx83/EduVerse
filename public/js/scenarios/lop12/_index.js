...
let m_toan = {}, m_nv = {}, m_ta = {}, m_ly = {}, m_hoa = {}, m_sinh = {}, m_su = {}, m_dia = {}, m_gdcd = {}, m_tin = {}, m_cn = {}, m_gdqp = {}, m_hdtn = {};
...
try { ({ H12HDTN_SCENARIOS: m_hdtn } = await import('./hdtn.js')); } catch {}
let LOP12_LESSONS = {};
try { ({ LOP12_LESSONS } = await import('./lessons/_index.js')); } catch {}
export const HIGHSCHOOL_LOP12_SCENARIOS = { ...m_toan, ...m_nv, ...m_ta, ...m_ly, ...m_hoa, ...m_sinh, ...m_su, ...m_dia, ...m_gdcd, ...m_tin, ...m_cn, ...m_gdqp, ...m_hdtn };
