...
export const P2_TOAN_WEEKS = [
  ...
  M(35, 'Chu vi tam giác – tứ giác', [
    ...
    Q('Một hình gồm nhiều đoạn thẳng nối tiếp nhau gọi là gì?', ['Đường gấp khúc', 'Đường tròn', 'Một điểm', 'Một đoạn thẳng duy nhất'], 0, 'Nhiều đoạn thẳng nối tiếp tạo thành đường gấp khúc.', ['Đúng — đường gấp khúc là nhiều đoạn thẳng nối tiếp nhau tại các đầu mút.', 'Sai — đường tròn cong đều, không gồm các đoạn thẳng.', 'Sai — một điểm không có chiều dài, không phải đường gấp khúc.', 'Sai — chỉ một đoạn thẳng thì chưa gấp khúc, cần nhiều đoạn nối tiếp.']),
    Q('Đường gấp khúc tạo bởi ba đoạn AB, BC, CD có mấy đoạn thẳng?', ['2 đoạn', '3 đoạn', '4 đoạn', '1 đoạn'], 1, 'AB, BC, CD là 3 đoạn thẳng.', ['Sai — em đếm thiếu một đoạn, có cả AB, BC và CD.', 'Đúng — đường gấp khúc này gồm 3 đoạn thẳng: AB, BC, CD.', 'Sai — chỉ có 3 đoạn, em đếm dư một đoạn.', 'Đúng đâu — đó mới là một đoạn, đường này có tới 3 đoạn.']),
    Q('Đường gấp khúc gồm ba đoạn dài 3 cm, 4 cm và 2 cm. Độ dài đường gấp khúc là?', ['9 cm', '7 cm', '8 cm', '12 cm'], 0, 'Độ dài = tổng các đoạn: 3 + 4 + 2 = 9 cm.', ['Đúng — độ dài đường gấp khúc là tổng độ dài các đoạn: 3 + 4 + 2 = 9 cm.', 'Sai — em quên cộng đoạn 2 cm, đúng là 9 cm.', 'Sai — em cộng thiếu, đủ ba đoạn là 9 cm.', 'Sai — em cộng dư rồi, ba đoạn cộng lại chỉ 9 cm.']),
    Q('Điều gì khác nhau giữa đoạn thẳng và đường gấp khúc?', ['Đoạn thẳng chỉ là một nét thẳng, còn đường gấp khúc gồm nhiều đoạn thẳng nối tiếp', 'Hai cái hoàn toàn giống nhau', 'Đoạn thẳng có nhiều khúc gấp hơn đường gấp khúc', 'Đường gấp khúc luôn là một nét thẳng không có chỗ gấp'], 0, 'Đoạn thẳng là một nét thẳng; đường gấp khúc gồm nhiều đoạn nối tiếp tại các đầu mút.', ['Đúng — đoạn thẳng chỉ một nét thẳng, còn đường gấp khúc gồm nhiều đoạn thẳng nối tiếp nhau.', 'Sai — hai cái khác nhau: một bên một nét, một bên nhiều đoạn nối tiếp.', 'Sai — ngược lại, đường gấp khúc mới có các chỗ gấp.', 'Sai — đường gấp khúc có chỗ gấp, không phải một nét thẳng.']),
  ]),
