...
export const USER_PLANS = {
  guest: { id: 'guest', name: 'Khách',    rank: 0, price_month_vnd: 0,       price_year_vnd: 0,         ai_calls_day: 0,   domains_allow: ['preschool'] },
  free:  { id: 'free',  name: 'Miễn phí', rank: 1, price_month_vnd: 0,       price_year_vnd: 0,         ai_calls_day: 20,  domains_allow: ['preschool', 'primary'] },
