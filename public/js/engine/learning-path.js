// ============================================================
// LearningPath — Trường Dược ảo (Virtual Pharmacy University)
// ============================================================
// 115+ nhiệm vụ tổ chức theo 6 cụm:
//   1. CURRICULUM (35)   — Lộ trình 5 năm chính quy
//   2. PRACTICE (20)     — Cơ sở thực hành (BV, nhà thuốc, nhà máy)
//   3. SKILL (15)        — Trung tâm kỹ năng (OSCE, AI patient, cấp cứu)
//   4. LIBRARY (12)      — Thư viện + nghiên cứu
//   5. CAREER (10)       — 10 lộ trình sự nghiệp
//   6. GAME (10)         — Game + giải đấu
//
// Engine vẫn dùng MODULES cho mọi tính toán (unlock, certificate, progress).
// ============================================================
...
export const MODULES = [
  ...
  { category: 'curriculum', id: 'L5.1', title: 'Dược lâm sàng đa khoa',       yearLevel: 5, subject: 'duoc-lam-sang',  scenarioIds: [/* 10 ca tự sinh */], minStarsToUnlock: 24, prerequisites: ['L4.2'] },
  ...
  //              Cơ sở thực hành — bệnh viện, nhà thuốc, nhà máy
  // ══════════════════════════════════════════════════════════════

  // ── Bệnh viện ảo (10 khoa) ──
  { category: 'practice', id: 'PS01', title: '🚨 Phòng Cấp cứu (ER)',          subject: 'er-pharmacy',       scenarioIds: [], minStarsToUnlock: 30, icon: '🚨' },
  { category: 'practice', id: 'PS02', title: '🛏️ ICU Dược',                    subject: 'icu-pharmacy',      scenarioIds: [], minStarsToUnlock: 30, icon: '🛏️' },
  { category: 'practice', id: 'PS03', title: '❤️ Khoa Nội (Tim mạch, Nội khoa)', subject: 'internal-med',     scenarioIds: [], minStarsToUnlock: 24, icon: '❤️' },
  ...
  { category: 'practice', id: 'PS07', title: '🎗️ Khoa Ung bướu — Hoá trị',     subject: 'onco-pharm',        scenarioIds: [], minStarsToUnlock: 30, icon: '🎗️', hasCertificate: true },
  ...
  { category: 'practice', id: 'PS20', title: '⚠️ Pharmacovigilance — Báo cáo ADR', subject: 'pharmacovig',    scenarioIds: [], minStarsToUnlock: 24, icon: '⚠️' },

  // ══════════════════════════════════════════════════════════════
  //              CỤM 3 — SKILL CENTERS (15)
  //              Trung tâm kỹ năng & mô phỏng tương tác
  // ══════════════════════════════════════════════════════════════
  ...
  { category: 'skill', id: 'SC09', title: '⚖️ Tư vấn giảm cân — béo phì',       subject: 'obesity',      scenarioIds: [], minStarsToUnlock: 12, icon: '⚖️' },
  { category: 'skill', id: 'SC10', title: '🥗 Tư vấn dinh dưỡng đặc biệt',      subject: 'nutrition',    scenarioIds: [], minStarsToUnlock: 12, icon: '🥗' },
  { category: 'skill', id: 'SC11', title: '✈️ Tư vấn du lịch — Vaccine + thuốc', subject: 'travel-med',  scenarioIds: [], minStarsToUnlock: 18, icon: '✈️' },
  { category: 'skill', id: 'SC12', title: '🌹 Tư vấn tránh thai',                subject: 'contraception', scenarioIds: [], minStarsToUnlock: 12, icon: '🌹' },
  { category: 'skill', id: 'SC13', title: '🎗️ Tư vấn HIV/STI',                  subject: 'hiv-sti',      scenarioIds: [], minStarsToUnlock: 18, icon: '🎗️' },
  ...
  //              Thư viện ảo & Trung tâm nghiên cứu
  // ══════════════════════════════════════════════════════════════
  ...
  { category: 'library', id: 'LR03', title: '🗣️ NC định tính — Phỏng vấn, FG',  subject: 'qualitative',  scenarioIds: [], minStarsToUnlock: 18, icon: '🗣️' },
  ...
  { category: 'library', id: 'LR06', title: '✏️ Viết khoá luận tốt nghiệp',      subject: 'thesis',       scenarioIds: [], minStarsToUnlock: 24, icon: '✏️' },
  ...
  //              10 lộ trình sự nghiệp + định hướng
  // ══════════════════════════════════════════════════════════════
  ...
  { category: 'career', id: 'CP05', title: '⚔️ Quân y — Dược quân đội',          subject: 'career',       scenarioIds: [], minStarsToUnlock: 24, icon: '⚔️' },
  { category: 'career', id: 'CP06', title: '⚠️ Cảnh giác dược — Pharmacovigilance', subject: 'career',   scenarioIds: [], minStarsToUnlock: 30, icon: '⚠️' },
 ...
 */
export function computeUnlock(progress) {
  const unlocked = [];
  const locked = [];
...
// Category metadata cho UI
export const CATEGORIES = {
  curriculum: { label: 'Khoa chuyên môn',     icon: '🎓', desc: 'Lộ trình 5 năm chính quy theo khung CTĐT ĐH Dược + CĐ Dược', color: '#fbbf24' },
  practice:   { label: 'Cơ sở thực hành',     icon: '🏥', desc: 'Bệnh viện ảo, nhà thuốc GPP, nhà máy GMP',                  color: '#10b981' },
